...
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(
	EditorPaneDescriptor.create(VoidSettingsPane, VoidSettingsPane.ID, nls.localize('VoidSettingsPane', "Deca\'s Settings Pane")),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('voidSettings', "Deca: Toggle Settings"),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('voidSettingsAction2', "Deca: Open Settings"),
			f1: true,
			icon: Codicon.settingsGear,
		});
	}
...
MenuRegistry.appendMenuItem(MenuId.GlobalActivity, {
	...
	command: {
		id: VOID_TOGGLE_SETTINGS_ACTION_ID,
		title: nls.localize('voidSettingsActionGear', "Deca\'s Settings")
	},
	order: 1
});
